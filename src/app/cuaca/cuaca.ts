...
@Component({
  selector: 'app-cuaca',
  imports: [Header, Sidebar, RouterModule, RouterLink, RouterLinkActive],
...
export class Cuaca implements AfterViewInit {
  ...
  getData(city:string): void {
    ...
    this.http
   .get(`https://api.openweathermap.org/data/2.5/forecast?q=${city}&appid=a10addd193b7887966a21c529dcbfc47`)
